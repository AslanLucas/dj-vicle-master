...
export const metadata: Metadata = {
  title: "Booking Anfrage | DJ VICLE",
  description:
    "Sende deine unverbindliche Booking-Anfrage an DJ VICLE für Hochzeit, Firmenfeier, Club oder Event.",
  alternates: {
    canonical: "https://www.djvicle.de/booking",
  },
};
...
const bookingSchema = {
  ...
  "@type": "ContactPage",
  name: "Booking Anfrage DJ VICLE",
  url: "https://www.djvicle.de/booking",
  mainEntity: {
    "@type": "Person",
    name: "DJ VICLE",
